...
- [ ] 3.2 创建 API 参考文档 (docs/zh-CN/user-guide/api-reference.md)
...
- [ ] 3.3 创建配置说明文档 (docs/zh-CN/user-guide/configuration.md)
...
- [ ] 3.4 创建使用示例集合 (docs/zh-CN/user-guide/examples.md)
  - 添加多账户管理场景示例
  - 添加配置备份和恢复示例
  - 添加批量操作示例
  - 添加故障排查示例
